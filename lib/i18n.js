...
(function (window) {
  const translations = {
    en: {
      ...
      btnDocx: "Word (.docx)",
      btnPng: "PNG Image",
      docListTitle: "Document List",
      tocListTitle: "Table of Contents (TOC)",
      assetInfoTitle: "Image Assets",
      dropTitle: "Drag & drop Markdown (.md) or Diagram (.mmd) files here",
      dropDesc: "Drop Markdown (.md), Diagram (.mmd), image folders, or ZIP archives.<br>All processing happens 100% locally inside your browser. No server uploads.",
      pickFolderBtn: "📂 Folder (with Images)",
      pickFileBtn: ".md / .mmd File",
      pickZipBtn: "🗜️ ZIP Archive",
      newDocBtn: "✍️ Start New Doc",
      ...
      zoomOut: "🔍 － Zoom Out",
      zoomReset: "🔄 100% Reset",
      exportSvg: "📥 SVG Download",
      exportPngModal: "🖼️ PNG Download",
  ...
  function applyLanguage(lang) {
    ...
    // 2. Update select dropdown if present
